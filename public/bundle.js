(function (Two) {
    ...
    function cloneOr0(s) {
        return copyIfExists(create$1(), s);
    }
    function clone$1(s) {
        return copy$1(create$1(), s);
    }
    ...
    class ElasticCollideCalc {
        ...
        _normalToCollisionLine(a, b, n) {
            if (n == null) {
                n = subtract$1(this._n, a.coords, b.coords); // normal to "collision line"
            }
            else {
                n = copy$1(this._n, n);
            }
        ...
        central(a, b, n) {
            ...
            let va = len$1(a.vel), vb = len$1(b.vel);
        ...
        nonCentral(a, b, n) {
            ...
            let v = a.vel;
            let dv = subtract$1(this.dv, a.vel, b.vel);
            let dn = scale$1(this.dn, n, 2 * dot$1(n, dv) * (mb / m));
            subtract$1(v, v, dn);
            v = b.vel;
            neg(n, n);
            neg(dv, dv);
    ...
    var defaults = baseRest(function(object, sources) {
      ...
      while (++index < length) {
        ...
        while (++propsIndex < propsLength) {
          ...
          if (value === undefined ||
              (eq$1(value, objectProto$k[key]) && !hasOwnProperty$h.call(object, key))) {
     ...
     * // => 24
     */
    var multiply$1 = createMathOperation(function(multiplier, multiplicand) {
    ...
    function omitBy(object, predicate) {
      return pickBy(object, negate$2(baseIteratee(predicate)));
    }
    ...
    function customDefaultsAssignIn(objValue, srcValue, key, object) {
      if (objValue === undefined ||
          (eq$1(objValue, objectProto$q[key]) && !hasOwnProperty$m.call(object, key))) {
        return srcValue;
      }
      return objValue;
    }
    ...
    var func = {
      ...
      flip, memoize, negate: negate$2, once, overArgs,
    ...
    var lang = {
      ...
      conformsTo, eq: eq$1, gt, gte, isArguments,
    ...
    var math = {
      add: add$2, ceil: ceil$1, divide: divide$1, floor: floor$1, max: max$1,
      maxBy, mean, meanBy, min: min$1, minBy,
      multiply: multiply$1, round: round$1, subtract: subtract$2, sum, sumBy
    };

    var number = {
      clamp, inRange, random: random$1
    };

    var object = {
      assign, assignIn, assignInWith, assignWith, at,
      create: create$3, defaults, defaultsDeep, entries: toPairs, entriesIn: toPairsIn,
