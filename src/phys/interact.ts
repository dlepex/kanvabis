...
import { Constructor, assert, int, nonNull } from "commons/prelude";
...
export class ElasticCollideCalc {
	...
	_normalToCollisionLine(a: PhysProps, b: PhysProps, n?: vec.Vec2Immut) {
		if (n === undefined) {
	...
	central(a: PhysProps, b: PhysProps, n?: vec.Vec2Immut) {
